package app.bmri.scripless.backing.lapdatavalidation;
...
public class LapDataValidationManagedBean {
    ...
    private final static String URL_PREFIX = "/laporandata?name=validationinvestor";
    ...
    public LapDataValidationManagedBean() {
    }
