package app.bmri.scripless.backing.lapdatastmt;
...
public class LapDataStatementManagedBean {
    ...
    private final static String URL_PREFIX = "/laporandata?name=statementinvestor";
    ...
    public LapDataStatementManagedBean() {
    }
